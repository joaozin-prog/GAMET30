...
class Phase1View(arcade.View):
    ...
    # Usamos um overlay preto desenhado diretamente (retângulo RGBA)
    # em vez de um Sprite, porque Sprite.draw() não está disponível
    # nas versões recentes do arcade.
    ...
    def on_draw(self):
        ...
        # arcade.Texture no longer fornece draw_sized em versões recentes.
        # Usar a função de desenho compatível com a versão instalada: draw_texture_rect
        # A assinatura aceita a Texture e um rect (XYWH)
        ...
        # Desenhar overlay preto com alpha (fade)
        # Usar a função disponível: draw_rect_filled(rect, color)
